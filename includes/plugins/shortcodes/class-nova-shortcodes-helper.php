    ...
    public static function getLoopProducts( $query_args, $atts, $loop_name ) {
        ...
        if( $layout == 'grid' ){
            if( isset($atts['enable_carousel'] ) && $atts['enable_carousel'] == 'yes' ) {
                ...
                $carousel_configs = ' data-nova_component="AutoCarousel" ';
        ...
        $params = array(
			...
			*/
            ...
            array(
                ...
                'description' 	=> esc_html__( 'Enter classname OR ID of Navigation, Ex: ".navigation_carousel", "#navigation_carousel"' ),
                'dependency' 	=> array(
                    'element' => 'arrows', 'value' => array( 'yes' )
                ),
                'group' 		=> esc_html__( 'Navigation' )
