...
class Novaworks_Shortcodes_Param {
    ...
    private function __construct() {
        ...
        vc_add_shortcode_param( 'nova_number' , array( $this, 'numberCallBack' ) );
    ...
    public function numberCallBack($settings, $value) {
    ...
    public function gradient_picker( $settings, $value ) {
        ...
        $output .= '<select id="grad_type' . $uni . '" class="grad_type" data-uniqid="' . $uni . '">
				<option value="vertical">' . esc_html__( 'Vertical', 'nova' ) . '</option>
				<option value="horizontal">' . esc_html__( 'Horizontal', 'nova' ) . '</option>
				<option value="custom">' . esc_html__( 'Custom', 'nova' ) . '</option>
			</select>
        ...
        $output .= '<div class="wpb_element_label" style="margin-top: 10px;">' . esc_html__( 'Choose Colors', 'nova' ) . '</div>';
    ...
    public function nova_slides_navigation( $settings, $value ) {
        ...
        if( $param_name == "dots_icon" ) {
            $icons = array( 'dlicon-dot1', 'dlicon-dot2', 'dlicon-dot3', 'dlicon-dot4', 'dlicon-dot5', 'dlicon-dot6', 'dlicon-dot7' );
        }
    ...
    public function nova_hotspot_image_preview( $settings, $value ) {
        $image_output = null;
