...
if( $the_query->have_posts() ){
    ...
    do_action('Novaworks/shortcodes/before_loop/', 'shortcode', 'la_show_portfolios', $atts);
    ...
    do_action('Novaworks/shortcodes/after_loop','shortcode', 'la_show_portfolios', $atts);
