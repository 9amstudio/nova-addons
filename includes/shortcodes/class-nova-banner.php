...
class WPBakeryShortCode_nova_banner extends WPBakeryShortCode {
	...
	public function getStyles( $el_class, $css, $google_fonts_data, $font_container_data, $atts ) {
		...
		/**
		 * Filter 'VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG' to change nova_banner class
		 *
		 ...
		 * @since 4.3
		 */
		$css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, implode( ' ', $css_class ), $this->settings['base'], $atts );
...
/**
 * Class WPBakeryShortCode_nova_banner5
 */
class WPBakeryShortCode_nova_banner5 extends WPBakeryShortCode {
