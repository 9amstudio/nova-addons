 ...
 *
 */
class Novaworks_Framework_Field_autocomplete extends Novaworks_Framework_Field_Base {
    ...
    public function output() {
        ...
        echo '<div class="nova-autocomplete" data-query=\'' . $query . '\'>';
